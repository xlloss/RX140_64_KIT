...
*              : 03/16/2022 1.50    Adding Multiple Electrode Connection Supporting
*              : 03/31/2023 1.51    Improving Traceability
*              : 04/18/2023 1.60    Adding 3 Frequency Judgement Supporting
***********************************************************************************************************************/
/***********************************************************************************************************************
...
{
    { .ssdiv = CTSU_SSDIV_4000, .so = 0x0E4, .snum = 0x07, .sdpa = 0x07 },
    { .ssdiv = CTSU_SSDIV_4000, .so = 0x111, .snum = 0x07, .sdpa = 0x07 },
};
...
const ctsu_cfg_t g_qe_ctsu_cfg_config01 =
{
    ...
    .ctsuchac1  = 0x80, /* ch8-ch15 enable mask */
