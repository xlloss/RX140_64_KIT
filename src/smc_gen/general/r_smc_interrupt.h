...
#define ICU_CTSU_CTSUWR_PRIORITY                   (_02_ICU_PRIORITY_LEVEL2)
#define ICU_CTSU_CTSURD_PRIORITY                   (_02_ICU_PRIORITY_LEVEL2)
#define ICU_CTSU_CTSUFN_PRIORITY                   (_02_ICU_PRIORITY_LEVEL2)
